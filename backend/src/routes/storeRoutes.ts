...
storeRoute.put('/update', isAuthenticated, requireMerchant, requireApprovedVerification, updateStore);
storeRoute.get('/details', isAuthenticated, requireMerchant, getStoreDetails);
storeRoute.delete('/delete', isAuthenticated, requireMerchant, requireApprovedVerification, deleteStoreDetails);
